...
export function getPseudo(code) {
  ...
  function Pseudo(name, charMap, modFn) {
  ...
  const qps = {
    'qps-ploc': ['Runtime Accented', ACCENTED_MAP, makeLonger],
    'qps-plocm': ['Runtime Mirrored', FLIPPED_MAP, makeRTL],
  };

  return new Pseudo(...qps[code]);
}
