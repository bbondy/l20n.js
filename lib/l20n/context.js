...
var formatValue = require('./resolver').formatValue;
var formatEntity = require('./resolver').formatEntity;
...
Context.prototype.get = function(id, ctxdata) {
  ...
  return formatValue(entry, ctxdata) || '';
};
...
Context.prototype.getEntity = function(id, ctxdata) {
  ...
  return formatEntity(entry, ctxdata);
};
