...
define(function (require, exports, module) {
  ...
  Resource.prototype.parse = function R_parse(callback, err, text) {
    if (err) {
      ...
      this.ast = this.ctx._parser.parse(this.source);
    } else {
  ...
  Locale.prototype.build = function L_build(callback) {
    ...
    function resourceBuilt(err) {
      ...
      if (resourcesToBuild === 0) {
        ...
        self.flatten.call(self, function onLocaleBuilt() {
          self.ctx._cleanComponents();
          if (callback) {
            callback();
          }
        });
  ...
  Context.prototype._initComponents = function C_initComponents() {
  ...
  Context.prototype._cleanComponents = function C_cleanComponents() {
    this._parser = null;
    this._compiler = null;
  };
  ...
  Context.prototype._add = function C_add(text, locale) {
    var res = new Resource(null, this);
    res.source = text;
